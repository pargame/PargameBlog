...
3.  **내부 동작**:
	\`MoveTo\` 함수는 내부적으로 \`UNavigationSystemV1::FindPathToLocationSynchronously\`와 같은 함수를 호출하여 경로를 계산하고, 계산된 경로를 따라 [[APawn]]의 [[UCharacterMovementComponent]]에 이동 명령을 내립니다.`;export{n as default};
//# sourceMappingURL=UNavigationSystemV1-BZQrznd3.js.map
