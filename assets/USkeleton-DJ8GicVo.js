...
* **다른 스켈레톤 간의 공유**:
	두 개의 서로 다른 \`USkeleton\` 애셋이 있더라도, 각 뼈의 역할(예: '이 뼈는 머리다', '이 뼈는 왼손이다')을 매핑해주는 '리타겟 매니저'를 설정하면, 한 스켈레톤의 애니메이션을 다른 스켈레톤을 사용하는 메시에서 재생할 수 있습니다.`;export{e as default};
//# sourceMappingURL=USkeleton-DJ8GicVo.js.map
