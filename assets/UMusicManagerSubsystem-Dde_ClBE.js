...
4.  예를 들어, 보스전 트리거 볼륨에 플레이어가 들어가면, \`MusicManagerSubsystem->ChangeMusic(BossMusicData)\`를 호출하여 배경 음악을 보스전 음악으로 변경합니다.`;export{n as default};
//# sourceMappingURL=UMusicManagerSubsystem-Dde_ClBE.js.map
