...
* **[[UGameplayStatics]]**:
	\`PlaySoundAtLocation\`, \`SpawnSound2D\` 등 월드의 특정 위치나 화면 전체에 일회성 사운드를 간편하게 재생할 수 있는 함수들을 제공합니다. 내부적으로는 임시 \`UAudioComponent\`를 생성하여 사용하는 방식입니다.`;export{n as default};
//# sourceMappingURL=UAudioComponent-DbpQoeGJ.js.map
