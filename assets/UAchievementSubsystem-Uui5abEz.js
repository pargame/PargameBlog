...
4.  게임플레이 코드에서 특정 조건이 만족되면(예:
	적이 죽으면), \`GetGameInstance()->GetSubsystem<UAchievementSubsystem>()->ReportProgress("Kill100Enemies", 1)\`과 같이 호출하여 진행 상황을 알립니다.`;export{e as default};
//# sourceMappingURL=UAchievementSubsystem-Uui5abEz.js.map
