...
---
> **UMaterial는 엔진에서 사용되는 클래스/컴포넌트로, 주요 속성 및 사용법을 설명합니다.**
...
> **// 간단한 예시 // UMaterial 사용 예시를 추가하세요. 실무 팁: 프로젝트 요구에 맞는 설정을 우선 검토하세요.**
\`\`\`cpp
// 간단한 예시
// UMaterial 사용 예시를 추가하세요.
\`\`\`
`;export{n as default};
//# sourceMappingURL=UMaterial-Io0gcxsW.js.map
