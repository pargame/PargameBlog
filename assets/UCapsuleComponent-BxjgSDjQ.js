...
* **간단한 공격 판정**:
	무기 액터의 끝에 작은 캡슐 컴포넌트를 붙여, 공격 애니메이션 중에 다른 캐릭터의 \`UCapsuleComponent\`와 겹쳤는지를 검사하여 피해 판정을 할 수 있습니다.`;export{n as default};
//# sourceMappingURL=UCapsuleComponent-BxjgSDjQ.js.map
