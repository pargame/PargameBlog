...
4.  **생성 및 표시**:
	레벨 블루프린트나 플레이어 컨트롤러 등에서 \`Create Widget\` 노드로 위젯의 인스턴스를 생성하고, \`AddToViewport\` 노드를 사용하여 화면에 표시합니다.`;export{n as default};
//# sourceMappingURL=UnrealMotionGraphics-BwGLmgs8.js.map
