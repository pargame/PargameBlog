...
4. **활성화**:
	코드나 블루프린트에서 [[USkeletalMeshComponent]]의 \`SetSimulatePhysics(true)\`를 호출하면, 애니메이션이 중단되고 \`UPhysicsAsset\`에 정의된 대로 물리 시뮬레이션이 시작됩니다.`;export{e as default};
//# sourceMappingURL=UPhysicsAsset-dBRqA7kA.js.map
